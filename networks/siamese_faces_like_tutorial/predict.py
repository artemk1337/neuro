...
def load():
    ...
    def load_img(s1, s2):
        ...
        img0 = cv2.resize(img0, dsize=size, interpolation=cv2.INTER_AREA)
        ...
        img1 = cv2.resize(img1, dsize=size, interpolation=cv2.INTER_AREA)
...
model = keras.models.load_model('data/model_faces_wb', custom_objects={'contrastive_loss': contrastive_loss})
